...
public class ScriptController : ControllerBase
{
    ...
    [HttpPost("Script")]
    public async Task<IActionResult> UploadAsync([FromForm] ScriptPostParams @params) => Ok(await _handler.UploadAsync(@params));

    [HttpPut("Script")]
    public async Task<IActionResult> UpdateAsync([FromForm] ScriptPutParams @params) => Ok(await _handler.UpdateAsync(@params));
