...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.LogVisualization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("LogVisualization", (string)null);
                });
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserMovie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserScript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserScript", (string)null);
                });

            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserSoundTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserSoundTrack", (string)null);
                });
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.LogVisualization", b =>
                {
                    b.HasOne("Paradiso.API.Domain.Entities.User", "User")
                        .WithMany("LogVisualizationsUser")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Paradiso.API.Domain.Entities.User", "Viewer")
                        .WithMany("LogVisualizationsViewer")
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserMovie", b =>
                {
                    b.HasOne("Paradiso.API.Domain.Entities.Movie", "Movie")
                        .WithMany("UserMovies")
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserPhoto", b =>
                {
                    b.HasOne("Paradiso.API.Domain.Entities.Photo", "Photo")
                        .WithMany("UserPhotos")
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserScript", b =>
                {
                    b.HasOne("Paradiso.API.Domain.Entities.Script", "Script")
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.UserSoundTrack", b =>
                {
                    b.HasOne("Paradiso.API.Domain.Entities.SoundTrack", "SoundTrack")
                        .WithMany("UserSoundTracks")
            ...
            modelBuilder.Entity("Paradiso.API.Domain.Entities.User", b =>
                {
                    b.Navigation("LogVisualizationsUser");

                    b.Navigation("LogVisualizationsViewer");
