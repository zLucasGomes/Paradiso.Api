...
public class MovieController : ControllerBase
{
    ...
    [HttpPost("Movie")]
    public async Task<IActionResult> UploadAsync([FromForm] MoviePostParams @params) => Ok(await _handler.UploadAsync(@params));

    [HttpPut("Movie")]
    public async Task<IActionResult> UpdateAsync([FromForm] MoviePutParams @params) => Ok(await _handler.UpdateAsync(@params));
