...
public class PhotoController : ControllerBase
{
    ...
    [HttpPost("Photo")]
    public async Task<IActionResult> UploadAsync([FromForm] PhotoPostParams @params) => Ok(await _handler.UploadAsync(@params));

    [HttpPut("Photo")]
    public async Task<IActionResult> UpdateAsync([FromForm] PhotoPutParams @params) => Ok(await _handler.UpdateAsync(@params));
