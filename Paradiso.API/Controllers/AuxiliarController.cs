...
public class AuxiliarController : ControllerBase
{
    ...
    [HttpPost("LogVisualization")]
    public async Task<IActionResult> UploadAsync([FromBody] LogVisualizationPostParams @params) => Ok(await _handler.UploadLogVisualizationAsync(@params));
